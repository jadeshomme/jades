    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Danh sách chuyên mục</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-title">
                    <h3 class="card-label">Chuyên mục
            ...
            <div class="row">
                ...
                <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 1066px;">
                    <thead>
                        <tr role="row">
                            <th class="sorting sorting_asc" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 100px;" aria-label="Agent: activate to sort column descending">ID</th>
                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 154px;" aria-label="Company Email: activate to sort column ascending">Tên chuyên mục</th>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 155px;" aria-label="Company Name: activate to sort column ascending">Ngày tạo</th>
                    ...
                    @foreach ($get_new_category as $category)
                        <tr class="odd">
                                ...
                                <td>
                                    <a href="{{ route('dashboard.newsCategory.edit', ['id' => $category->id]) }}">{{$category->name}}</a>
                                </td>
                                ...
                                <td nowrap="nowrap">
                                    ...
                                    <a href="{{ route('dashboard.newsCategory.edit', ['id' => $category->id]) }}" class="btn btn-sm btn-clean btn-icon" title="Edit details">
                                        <i class="la la-edit"></i>
                                    </a>
                                    <a href="javascript:;" class="btn btn-sm btn-clean btn-icon delete_new_category" data-id="{{$category->id}}" title="Delete">
...
<script>
    $(document).on("click",".delete_new_category",function() {
            ...
            buttons: {
                'Yes': {
                    action: function () {
                        ...
                        axios({
                            method: 'post',
                            url: '/admin-manager/news/category/delete',
                            data: {
                                id:id,
                            }
