...
<style>
    ...
    <div class="container">
        ...
        <form id="form" method="post" action="{{ route('dashboard.newsCategory.addPost') }}" enctype="multipart/form-data">
        @csrf
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control name" placeholder="Tên chuyên mục" value="">
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label>Slug</label>
                    <input type="text" name="slug" class="form-control slug" placeholder="Vd:khai-truong" value="">
                </div>
                  <!-- /.form-group -->
