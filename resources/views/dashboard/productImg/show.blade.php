    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Danh sách ảnh sản phẩm</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <div class="card-title">
                    <h3 class="card-label">List ảnh sản phẩm
                ...
                <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 1066px;">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 154px;" aria-label="Company Email: activate to sort column ascending">Mã sản phẩm</th>
                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 100px;" aria-label="Company Agent: activate to sort column ascending">Danh sách ảnh</th>
                            ...
                            <td class="dtr-control sorting_1" tabindex="0">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50 flex-shrink-0">
                                        <img  src="{{asset('/uploads/images/'.$get_products->product_img.'')}}" alt="photo">
                                    </div>
                                    <div class="ml-3">
                                        <a href="{{ route('dashboard.product.editImg', ['id' => $get_products->id]) }}" class="text-dark-75 font-weight-bold line-height-sm d-block pb-2">{{$get_products->product_name}}</a>
                                    </div>
                                </div>
                            </td>
                                <td >{{$get_products->product_code}}</td>

                                <td class="dtr-control sorting_1" tabindex="0">
                                    <div class="d-flex align-items-center">
                                    @foreach ($get_products->productImg as $item)
                                        <div class="symbol symbol-50 flex-shrink-0">
                                ...
                                <td>{{ date('d/m/Y H:i', strtotime($get_products->updated_at)) }}</td>
                                <td nowrap="nowrap">
                                    ...
                                    <a href="{{ route('dashboard.product.editImg', ['id' => $get_products->id]) }}" class="btn btn-sm btn-clean btn-icon" title="Edit details">
                                        <i class="la la-edit"></i>
                                    </a>
                                    <a href="javascript:;" class="btn btn-sm btn-clean btn-icon delete_product_img" data-id="{{$get_products->id}}" title="Delete">
...
<script>
    $(document).on("click",".delete_product_img",function() {
