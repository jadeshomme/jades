...
<style>
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Thêm mới slider website</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
    ...
    <div class="container">
        ...
        <form id="form" method="post" action="{{ route('dashboard.slider.addPost') }}" enctype="multipart/form-data">
        @csrf
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control name" placeholder="Tên slider" value="">
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label>Nội dung</label>
                    <textarea class="form-control" name="content" rows="3" placeholder="nội dung" maxlength="65535"></textarea>
                </div>
                  <!-- /.form-group -->
