    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Danh sách sản phẩm</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
                            ...
                            <td class="dtr-control sorting_1" tabindex="0">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50 flex-shrink-0">
                                        <img src="{{asset('/uploads/images/'.$product->product_img.'')}}" alt="photo">
                                    </div>
                                    <div class="ml-3">
                                        <a href="{{ route('dashboard.product.edit', ['id' => $product->product_code]) }}" class="text-dark-75 font-weight-bold line-height-sm d-block pb-2">{{$product->product_name}}</a>
                                    </div>
                                </div>
                            </td>
                                <td class="">{{$product->product_code}}</td>
                                @if ($product->status == 1)
                                    <td><span class="label label-lg font-weight-bold label-light-success label-inline">Đang bán</span></td>
                                @else
                                <td><span class="label label-lg font-weight-bold label-light-danger label-inline">Dừng bán</span></td>
                                @endif
                                ...
                                <td nowrap="nowrap">
                                    ...
                                    <a href="{{ route('dashboard.product.edit', ['id' => $product->product_code]) }}" class="btn btn-sm btn-clean btn-icon" title="Edit details">
                                        <i class="la la-edit"></i>
                                    </a>
                                    <a href="javascript:;" class="btn btn-sm btn-clean btn-icon delete_product" data-id="{{$product->id}}" title="Delete">
