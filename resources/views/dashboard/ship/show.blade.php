    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Danh sách đơn vị vận chuyển</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
        ...
        <div class="card card-custom">
            ...
            <div class="row">
                ...
                <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info">
                    ...
                    <tbody>
                        @foreach ($get_ship as $ships)
                        <tr class="odd">
                            <td class="dtr-control sorting_1" tabindex="0">
                                <div class="d-flex align-items-center">
                                    <div class="ml-3">
                                        <a href="{{ route('dashboard.ship.edit', ['id' => $ships->ship_code]) }}" class="text-dark-75 font-weight-bold line-height-sm d-block pb-2">{{$ships->ship_name}}</a>
                                    </div>
                                </div>
                            </td>
                                <td class="">{{$ships->ship_code}}</td>
                                @if ($ships->status == 1)
                                ...
                                @endif
                                <td>{{ date('d/m/Y H:i', strtotime($ships->updated_at)) }}</td>
                                <td nowrap="nowrap">
                                    ...
                                    <a href="{{ route('dashboard.ship.edit', ['id' => $ships->ship_code]) }}" class="btn btn-sm btn-clean btn-icon" title="Edit details">
                                        <i class="la la-edit"></i>
                                    </a>
                                    <a href="javascript:;" class="btn btn-sm btn-clean btn-icon delete_ship" data-id="{{$ships->id}}" title="Delete">
...
<script>
    $(document).on("click",".delete_ship",function() {
